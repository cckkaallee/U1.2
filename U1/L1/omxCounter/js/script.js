...
function areaCalculations() {
  ...
  resultElem.innerHTML =
    "<p>Rektangelns area är " + area + " m<sup>2</sup></p>";
  ...
  resultElem.innerHTML +=
    "<p> Längden +5 ger rektangelns area " + area + " m<sup>2</sup></p>";
  ...
  resultElem.innerHTML +=
    "<p> Då längden ökas med 50% och bredden med 3 blir rektangelns area " +
    area +
    " m<sup>2</sup></p>";
  ...
  resultElem.innerHTML +=
    "<p> Triangelns area blir " + area + " kvadratfot<sup>2</sup></p>";
}
